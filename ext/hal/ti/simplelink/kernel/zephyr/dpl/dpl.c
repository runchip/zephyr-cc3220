...
static char __stack spawn_task_stack[SPAWN_TASK_STACKSIZE];
...
{
	k_thread_spawn(&spawn_task_stack[0], SPAWN_TASK_STACKSIZE,
		       spawn_task, NULL, NULL, NULL, SPAWN_TASK_PRIORITY,
		       0, 0);
	return 0;
}
